...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick_calculateBMI(View view){
        ...
        EditText heightTF = (EditText) findViewById(R.id.Edit1);
        EditText weightTF = (EditText) findViewById(R.id.Edit);
        ...
        TextView BMIResult = (TextView) findViewById(R.id.textView);
